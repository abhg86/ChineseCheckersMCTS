...
if __name__ == "__main__":
    ...
    parser.add_argument('--first-player', choices=['human', 'minimax','random', 'nonrepeatrandom', 'MCTS', 'GRAVE'], required=False,
    ...
    parser.add_argument('--second-player', choices=['minimax','random', 'nonrepeatrandom', 'MCTS', 'GRAVE'], required=False,
